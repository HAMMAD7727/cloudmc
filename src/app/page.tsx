      ...
      <header className="relative w-full h-[560px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-4">
          <div className="bg-black/20 backdrop-blur-md p-6 sm:p-8 rounded-xl space-y-4 animate-slide-in">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-white font-headline drop-shadow-lg animate-slide-in [animation-delay:0.2s]">
              Cloudverse Store
            </h1>
            <p className="text-lg md:text-xl text-white/90 drop-shadow-md max-w-xs sm:max-w-none animate-slide-in [animation-delay:0.4s]">
          ...
          <Button asChild className="mt-8 bg-primary hover:bg-primary/90 text-primary-foreground group transition-transform duration-300 hover:scale-105 animate-slide-in [animation-delay:0.8s]" size="lg">
          ...
          <div className="sticky top-0 bg-background/80 backdrop-blur-sm border-b z-10">
            <ScrollArea className="w-full whitespace-nowrap">
              <TabsList className="container mx-auto h-16 rounded-none bg-transparent p-0 flex sm:inline-flex">
                ...
                <TabsTrigger value="features" className="h-full rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-primary/10 data-[state=active]:shadow-none text-base font-semibold transition-colors duration-300 hover:bg-primary/5">Features</TabsTrigger>
                <TabsTrigger value="news" className="h-full rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-primary/10 data-[state=active]:shadow-none text-base font-semibold transition-colors duration-300 hover:bg-primary/5">News</TabsTrigger>
                <TabsTrigger value="community" className="h-full rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-primary/10 data-[state=active]:shadow-none text-base font-semibold transition-colors duration-300 hover:bg-primary/5">Community</TabsTrigger>
